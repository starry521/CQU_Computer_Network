    ...
    public void run() {
        try {
            ...
            while(true) {
                ...
                int result = JOptionPane.showConfirmDialog(new JPanel(), "是否接受？", "提示  "+userName,
...
//					out.flush();
                    File userFile = new File("C:\\Users\\JOHN\\Desktop\\接收文件"+userName);
//                    File userFile = new File("/Users/herui/ChatWAY/接收文件/"+userName);
                    if(!userFile.exists()) {  // 新建当前用户的文件夹
                        userFile.mkdir();
                    }
                    System.out.println("ok");
                    File file = new File("C:\\Users\\JOHN\\Desktop\\接收文件" + userName + "\\" + textName);
//                    File file = new File("/Users/herui/ChatWAY/接收文件/" + userName + "/" + textName);
...
//                    out.flush();
                    System.out.println("文件存放地址：\n" + "C:\\Users\\JOHN\\Desktop\\接收文件" + userName + "\\" + textName);
                    // 提示文件存放地址
    ...
    // 客户端发送文件
    static void outFileToServer(String path, String currentChatObject) {
        try {
            ...
            fileOut.flush();
            System.out.println("发送文件的对象" + currentChatObject);
